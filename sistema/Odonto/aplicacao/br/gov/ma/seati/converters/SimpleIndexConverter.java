package br.gov.ma.seati.converters;
 ...
 * Walter Júnior
 * 
 * Classe responsável por fazer a conversão de um objeto SelectItem, muito
 * utilizado em combo em um determinado objeto específico. Isso é feito
 * geralmente quanse se quer setar um objeto diretamente dentro de um
 * outro.
 */
...
*/        
    ...
    @SuppressWarnings("unchecked")
	protected void resolveAndAddItems(SelectItemGroup group, @SuppressWarnings("rawtypes") List items) {  
